...
import Deposite from "../User_Dashboard/Deposite";
import Withdrawal from "../User_Dashboard/withdrawal";
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/general-notice-and-terms"
          element={<GeneralNoticeAndTerms />}
        />
       ...
       <Route path='/Chain-Split-Tokens-and-Token-Manager-on-Ekonnet' element={<Question21/>}/>  */}
        ...
        <Route
          path="/immediate-cancellation-order"
          element={<ImmediateOrder />}
        />
        ...
        <Route
          path="/user-derivatives-home"
          element={<UserDerivativesHome />}
        />
        ...
        <Route
          path="/user-lending-product-home"
          element={<UserLendingProductHome />}
        />
        <Route path="/user-account" element={<UserAccount />} />
        <Route path="/user-sub-account" element={<UserSubAccount />} />
        <Route
          path="/user-security-account"
          element={<UserSecurityAccount />}
        />
        ...
        <Route
          path="/application-programming-interface"
          element={<ApplicationProgrammingInterface />}
        />
        ...
        <Route
          path="/lost-access-to-google-authenticator-2fa-of-a-ekonnet-account"
          element={<LostAccess />}
        />
        <Route
          path="/how-to-reset-change-your-ekonnet-password"
          element={<ResetPassword />}
        />
        <Route path="/what-is the-invalid-token-message" element={<Token />} />
        <Route path="/verifications" element={<Verfications />} />
        <Route
          path="/verification-levels-at-ekonnet"
          element={<Verification1 />}
        />
        <Route
          path="/how-to-verify-an-individual-ekonnet-account"
          element={<Verification2 />}
        />
        <Route
          path="/how-to-verify-a-corporate-account-on-ekonnet"
          element={<Verification3 />}
        />
        <Route
          path="/how-long-does-ekonnet-verification-take"
          element={<Verification4 />}
        />
        <Route
          path="/verification-frequently-asked-questions(FAQ)"
          element={<Verification5 />}
        />
        <Route
          path="/ekonnet-master-and-sub-accounts"
          element={<Verification6 />}
        />
        <Route path="/reports" element={<Report />} />
        <Route path="/what-are-my-orders-reports" element={<Report1 />} />
        <Route
          path="/what-is-positions-on-ekonnet-report"
          element={<Report2 />}
        />
        <Route path="/what-is-a-ekonnet-report" element={<Report3 />} />
        <Route
          path="/what-is-a-funding-report-on-ekonnet"
          element={<Report4 />}
        />
        <Route path="/what-are-my-trades-reports" element={<Report5 />} />
        <Route
          path="/what-is-my-wallet-history-on-ekonnet"
          element={<Report6 />}
        />
        <Route
          path="/what-is-my-movements-report-at-ekonnet"
          element={<Report7 />}
        />
        <Route
          path="/full-tax-report-ekonnet-reporting-application"
          element={<Report8 />}
        />
        <Route path="/trading-overviews" element={<Trading />} />
        <Route
          path="/currency-conversion-tool-on-ekonnet"
          element={<Trading1 />}
        />
        <Route path="/how-to-trade-on-ekonnet" element={<Trading2 />} />
        <Route
          path="/paper-trading-at-ekonnet-test-learn-and-simulate-trading-strategies"
          element={<Trading3 />}
        />
        <Route
          path="/ekonnet-order-types-and-order-options"
          element={<Trading4 />}
        />
        <Route
          path="/understanding-ekonnet-over-the-counter-(otc)"
          element={<Trading5 />}
        />
        <Route
          path="/how-to-check-you-are-paying-the-right-trading-fees-on-ekonnet"
          element={<Trading6 />}
        />
        <Route
          path="/what-is-the-minimum-order-size-on-ekonnet"
          element={<Trading7 />}
        />
        <Route
          path="/order-and-funding-books-terms-on-ekonnet"
          element={<Trading8 />}
        />
        <Route
          path="/the-ekonnet-chart-layout-customisation-and-ekonnet-trade-desk"
          element={<Trading9 />}
        />
        <Route path="/customisation-on-ekonnet" element={<Trading10 />} />
        <Route path="/ekonnet-satoshi-mode" element={<Trading11 />} />
        <Route
          path="/ekonnet-interface-loading-issues-frequently-asked-questions"
          element={<Trading12 />}
        />
        <Route path="/price-alert-setting-on-ekonnet" element={<Trading13 />} />
        <Route
          path="/what-is-a-settlement-on-ekonnet"
          element={<Trading14 />}
        />
        <Route
          path="/why-are-btc-profits-on-ekonnet-account-converted-to-usd-when-the-margin-position-is-closed"
          element={<Trading15 />}
        />
        <Route path="/trading-error-message" element={<Trading16 />} />
        <Route
          path="/editing-orders-and-viewing-order-history-in-bulk"
          element={<Trading17 />}
        />
        <Route
          path="/how-is-precision-calculated-using-significant-digits-on-ekonnet"
          element={<Trading18 />}
        />
        <Route path="/orders-execution-on-ekonnet" element={<Trading19 />} />
        <Route
          path="/why-a-stop-order-might-not-be-filled-at-the-stop-price-on-ekonnet"
          element={<Trading20 />}
        />
        <Route
          path="/chain-split-tokens-and-token-manager-on-ekonnet"
          element={<Trading21 />}
        />
        <Route path="/margin-trading" element={<Margin />} />
        <Route
          path="/What-is-Margin-Trading-on-Ekonnet"
          element={<Margin1 />}
        />
        <Route
          path="/How-to-open-close-a-margin-position-at-Ekonnet"
          element={<Margin2 />}
        />
        <Route
          path="/What-interest-rate-is-charged-on-margin-positions-on-Ekonnet"
          element={<Margin3 />}
        />
        <Route
          path="/How-to-claim-a-margin-position-on-Ekonnet"
          element={<Margin4 />}
        />
        <Route path="/Margin-call-policy-on-Ekonnet" element={<Margin5 />} />
        <Route
          path="/What-happens-to-a-Ekonnet-margin-position-if-the-underlying-funds-become-unavailable"
          element={<Margin6 />}
        />
        <Route path="/Margin-Funding-on-Ekonnet" element={<Margin7 />} />
        <Route
          path="/Is-it-possible-to-open-multiple-Margin-Trading-positions-for-the-same-pair-on-Ekonnet"
          element={<Margin8 />}
        />
        <Route
          path="/What-is-the-base-price-at-Ekonnet"
          element={<Margin9 />}
        />
        <Route
          path="/How-to-replace-funding-in-a-margin-position"
          element={<Margin10 />}
        />
        <Route
          path="/Using-Reserved-Funding-for-a-position-on-Ekonnet"
          element={<Margin11 />}
        />
        <Route
          path="/The-error-message-Insufficient-Balance-on-Ekonnet"
          element={<Margin12 />}
        />
        <Route path="/derivatives" element={<Derivative />} />
        <Route
          path="/How-to-move-funds-to-the-Derivatives-wallet"
          element={<Derivative1 />}
        />
        <Route
          path="/Derivatives-Trading-on-Ekonnet"
          element={<Derivative2 />}
        />
        <Route
          path="/The-Ekonnet-Derivatives-trading-interface"
          element={<Derivative3 />}
        />
        <Route
          path="/What-is-Termination-on-Ekonnet"
          element={<Derivative4 />}
        />
        <Route path="/fee" element={<Fee />} />
        <Route
          path="/How-to-pay-less-trading-fees-at-Ekonnet"
          element={<Fee1 />}
        />
        <Route path="/What-fees-does-Ekonnet-charge" element={<Fee2 />} />
        <Route path="/Ekonnet-Fees" element={<Fee3 />} />
        <Route
          path="/Does-Ekonnet-offer-traders-preferential-fee-discounts"
          element={<Fee4 />}
        />
        ...
        <Route
          path="/authentication"
          element={<Protected Cmp={Authentication} />}
        />
