        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/immediate-order"}><button id='button_active'>Immediate Cancellation Order</button>  
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    ...
                    <h3>What is a immediate cancellation order and how does it work?</h3>
