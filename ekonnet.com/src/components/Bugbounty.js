     ...
     <section id='bug_hero' className='bug_hero' style={{ backgroundImage: `url(${AffiliateImg})` }}>
      ...
      <section id='bug2' className='bug2  bg-[#131128] pt-[1px]'>
        <div className='container'>
         ...
         <ul>
          ...
          <li>not harm or defraud Bitfinex systems or our users during your investigation</li>
         ...
         <p>Work with us in good faith by following our responsible disclosure policy ensures no legal action will be taken against you by Bitfinex.</p>
         </div>
      ...
      <section id='bug2' className='bug2  bg-[#131128] pt-[1px]'>
        <div className='container'>
         ...
         <ul>
          ...
          <li>You must not try to access or damage other users' Bitfinex accounts. When completing the research, you must use your own Bitfinex account</li>
          <li>You must not attempt social engineering or phishing techniques on our users or Bitfinex personnel</li>
          ...
          <li>All decisions in relation to the administration of Bug Bounty program are at Bitfinex's sole and absolute discretion, including the distribution of rewards</li>
         </ul>
      ...
      <section id='bug3' className='bug3  bg-[#131128] pt-[1px]'>
        <div className='container'>
         ...
         <p>All bounties are priced in $USD and paid in USDt or Bitcoin or any other digital token as determined in Bitfinex's sole and absolute discretion.</p>
         <p>We are happy to give you recognition for your collaboration but will respect your privacy if you prefer not to reveal your identity publicly. Bitfinex may, at its sole discretion, honour your skills in its upcoming Hall of Fame, with any bugs appropriate for public disclosure.</p>
        ...
        <div className='container'>
         ...
         <p className='mt-5'>There must be an immediate threat to the Bitfinex platform or our users that can be exploited and is not hypothetical. Examples of common exclusions are:</p>
         <li>Vulnerabilities on sites hosted by third parties (https://bitfinex.recruitee.com, https://bitfinex.statuspage.io).</li>
         <li>Bitfinex-branded services operated by third parties</li>
         <li>Bitfinex open source projects: github.com</li>
         </div>
         </div>
        </div>
      </section>
      <section id='bug2' className='bug2  bg-[#131128] pt-[1px]'>
        <div className='container'>
         ...
         <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.<br/><br/>The bug report must include a short description of the bug, and a fully completed Bitfinex Bounty Report template. You must not share any sensitive data before you have made contact with an official representative at Bitfinex.
