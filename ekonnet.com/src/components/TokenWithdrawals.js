  ...
  return (
    ...
    <section id='token-deposite' className='token-deposite'>
     ...
     <label className='required'>Please select your issue below</label><br/>
        ...
        <datalist id="issue">
       <option value="Withdrawal mistakenly cancelled"/>
       <option value="Inserted the wrong tag, memo, or payment ID"/>
       <option value="Did not receive confirmation email"/>
       <option value="Withdrawal not received but is marked as completed"/>
       <option value="Other issue"/>
       </datalist> 
     </div>
     <div className='token-input'>
     <label className='required mt-5'>Token Name</label><br/>
     ...
     <div className='token-input'>
     <label className='required mt-3'>Withdrawal ID</label><br/>
        <input type="text" name="text" placeholder='Enter your withdrawals Id' className='mt-1'></input>  
     </div>
     <div className='token-input'>
     ...
     <div className='token-input'>
     <label className='required mt-3'>Transaction Address</label><br/>
...
export default TokenWithdrawals
