  ...
  <section className="contact__section">
    <div className="container">
        ...
        <div className="row mar-top d-flex justify-content-evenly align-items-center">
            ...
            <div className=" grp col-lg-6 col-sm-12 d-flex justify-content-start align-items-center">
            <input className='input' type="email" name="name" placeholder='Enter your email' />
            </div>
        </div>
        <div className="row d-flex justify-content-start align-items-start">
            <div className="col ">
            <textarea className='textarea' type="text-area" name="name" placeholder='Enter your message' />
            </div>
        </div>
