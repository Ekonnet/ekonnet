  ...
  return (
    ...
    <section id='token-deposite' className='token-deposite'>
     ...
     <label className='required'>Please select your issue below</label><br/>
        ...
        <datalist id="issue">
       <option value="A chart is not loading"/>
       <option value="I cannot see my balance"/>
       <option value="The order book is not loading"/>
       <option value="I see an error page"/>
       <option value="Other issue"/>
       </datalist> 
     </div>
     <div className='token-input'>
     <label className='required mt-3'>Browser (Chrome, Safari, Edge, Firefox or Other)</label><br/>
        <input type="text" name="text" placeholder='' className='mt-1'></input>  
     </div>
     <div className='token-input'>
     <label className='required mt-3'>Operating System (Android, iOS, Windows,...)</label><br/>
        <input type="text" name="text" placeholder='' className='mt-1'></input>  
     </div>
     <div className='token-input'>
