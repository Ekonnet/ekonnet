...
import './Account.css'
import trade50 from '../assets/trading50.png'
import trade51 from '../assets/trading51.png'
        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/ekonnet-satoshi-mode"}><button id='button_active'>Ekonnet (Satoshi) Mode</button></Nav.Link>
                ...
                <div className='col-lg-8 summer'>
                    ...
                    <p>
                    Satoshi (SAT) refers to the smallest unit of Bitcoin (BTC). One Satoshi (SAT) is equal to 0.00000001 Bitcoin (BTC), or one hundred millionth of a bitcoin. 
                    <br/><br/>
                    It is named after the founder of Bitcoin, Satoshi Nakamoto.<br/>
                    Bitcoins that are split into these smaller units make trading Bitcoin (BTC) easier and its transactions more readable for our users.
                    <br/><br/>
                    <h3>What is a Satoshi Mode</h3><br/>
                    The Ekonnet Satoshi Mode allows you to view Bitcoin in Satoshi units. When chosen, all trading pairs with BTC will be displayed in SAT units (1 SAT = 0.00000001 BTC). 
                    <br/><br/>
                    For example, BTC/USD would become SAT/USD, while ETH/BTC would become ETH/SAT.<br/><br/>
                    <h3>How to enable the Satoshi Mode</h3><br/>
                    To enable the Ekonnet Satoshi Mode:
                    <br/><br/>
                    1. Firstly, log in to your Ekonnet account.
                    <br/><br/>
                    2. Then, go to Account / Interface / Layout.
                    <br/><br/>
                    <img src={trade50} alt="main-heading" className='img-fluid mx-auto' /><br/> 
                    In Layout, choose from three types of view modes:
                    <br/>
                    <ul>
                      <li>BTC: Default setting</li>
                      <li>SAT (1/100M BTC)</li>
                      <li>BIT (1/1M BTC)</li>
                    </ul>
                    <img src={trade51} alt="main-heading" className='img-fluid mx-auto' /><br/> 
                    Note: The Ekonnet Satoshi Mode will be available on the Ekonnet trading page and funding page.
                    <br/><br/>
