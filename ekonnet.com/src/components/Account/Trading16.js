        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/trading-error-message"}><button id='button_active'>Trading Error Message</button></Nav.Link>
                ...
                <div className='col-lg-8 summer'>
                    <h2>Trading Error Message</h2>
                    <h5>Last updated 3 March, 2022</h5>
                    <p>
                    If you receive the error message "Can not place additional order at the moment" when trying to place an order, this is most likely due to the following reasons:
                    <br/><br/>
                    <h3>1. The Ekonnet platform is either in maintenance or overload</h3>
                    <br/>
                    Note: During maintenance, account holders will not be able to access wallets, and all features across the platform will be offline.
                    <br/><br/>
                    For the most recent updates, you can check these channels:
                    <ul>
                      <li>Ekonnet Announcements</li>
                      <li>Ekonnet Telegram</li>
                      <li>Ekonnet Status Page</li>
                    </ul>
                    <h3>2. You hit our dynamic throttle limit, which prevents users from placing a new order when the trade engine lag increases</h3><br/>
                    Note: This is rare and generally does not last more than a few seconds. It is designed to mitigate attacks by spam orders, regulate lag during a spike in activity and avoid flash crashes.
                    <br/><br/>
