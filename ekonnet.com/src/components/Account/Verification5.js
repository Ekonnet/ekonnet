        ...
        <div className='container'>
            <div className='row'>
                ...
                <div className='col-lg-8 summer'>
                    ...
                    <p>On Bitfinex, verification refers to the more commonly known KYC, an acronym for “know your customer” or “know your client”. 
                    <br/><br/>
                    ...
                    <br/><br/>
                    If you are using an individual account, you can upgrade your verification level to Basic Plus to access most of the available Bitfinex features such as deposits and withdrawals of listed cryptocurrencies including Tether tokens, make Exchange Trading and have access to the Bitfinex OTC market.
                    <br/><br/>
                    For corporate accounts, at least Intermediate level is required to access Bitfinex features, including deposits, withdrawals, trading, etc.
                    <br/><br/>
                    ...
                    *Important: 
                    <ul>
                        <li>Margin Trading, Margin Funding, Bitfinex Borrow, and Lending Pro requires at least Intermediate level verification for all Bitfinex accounts created after March 1, 2022. </li>
                    </ul>
                    ...
                    <br/>
                    Bitfinex offers two types of verification options:
                    <br/><br/>
                    ...
                    <h3>— What levels of access to Bitfinex are available?</h3>
                    <br/>
