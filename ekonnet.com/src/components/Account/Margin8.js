        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Is-it-possible-to-open-multiple-Margin-Trading-positions-for-the-same-pair-on-Ekonnet"}><button id='button_active'>Is it possible to open multiple Margin Trading positions for the same pair on Ekonnet</button></Nav.Link>
                ...
                <div className='col-lg-8 summer'>
                    <h2>Is it possible to open multiple Margin Trading positions for the same pair on Ekonnet</h2>
                    <h5>Last updated 3 March, 2022</h5>
                    <p>
                    No, only one Margin Trading position per trading pair can be opened at a time. 
                    <br/><br/>
                    If the existing position is not closed and you want to place an order on margin, the position will be updated with the new amount, and the Base Price will be changed to reflect the profit/loss partially realised on the new order.
                    <br/><br/>
