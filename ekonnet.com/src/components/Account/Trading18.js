        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/how-is-precision-calculated-using-significant-digits-on-ekonnet"}><button id='button_active'>How is precision calculated using significant digits on Ekonnet</button></Nav.Link>
                ...
                <div className='col-lg-8 summer'>
                    ...
                    <br/><br/>
                    The precision level of all trading prices is calculated based on significant figures. Ekonnet uses five significant digits for the prices of all pairs on Ekonnet. 
                    <br/><br/>
