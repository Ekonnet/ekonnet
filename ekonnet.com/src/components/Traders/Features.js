...
const Features = () => {
  return (
    <>
      ...
      <section id='exchangee' className='exchangee bg-[#131128] pt-[100px] ' >
        <div className='container'>
            <div className='row'>
      ...
      <section id='margin_trading' className='margin_trading bg-[#131128] pt-[100px]'>
        <div className='container'>
            <div className='row'>
                <div className='col-lg-6'>
      ...
      <section id='margin_funding' className='margin_funding bg-[#131128] pt-[100px]'>
        <div className='container'>
            <div className='row'>
                <div className='col-lg-6 ex'>
      ...
      <section id='Derivatives' className='Derivatives bg-[#131128] pt-[100px]'>
        <div className='container'>
            <div className='row'>
                <div className='col-lg-6'>
