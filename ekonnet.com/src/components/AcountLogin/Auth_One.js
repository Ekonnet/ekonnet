...
export default function AuthenticationOne() {
  ...
  const sign_id = localStorage.getItem('sign-id');
  ...
  const handleSubmit = (event) => {
    ...
    const formData = new FormData(event.currentTarget);
      ...
      formData.append('id', (JSON.stringify(sign_id)));
      console.log(inputs);
  ...
  return (
    <>
       <Helmet>
        <title>Ekonnet | Authentication </title>
      </Helmet>
      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          Two-Factor Authentication<br/>
           ...
           <Box component="form" onSubmit={handleSubmit} Validate sx={{ mt: 0, textAlign: "center" }}>
