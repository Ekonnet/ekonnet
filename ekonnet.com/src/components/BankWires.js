...
const BankWires = () => {
  return (
    ...
    <section id='token-deposite' className='token-deposite'>
     ...
     <p style={{color: "darkblue"}}>1. A Regular wire withdrawal request is sent out from Ekonnet within 5-10 business days. 2. An Express wire withdrawal is sent out from Ekonnet within 24 hours on any given business day and incurs a 1% processing fee. Ekonnet cannot guarantee processing of your withdrawal within a specified time frame as each bank will have its own procedures and processing times.</p>
     <form>
     ...
     <label className='required'>Please select your issue below</label><br/>
        ...
        <datalist id="issue">
       <option value="Withdrawal has not arrived yet"/>
       <option value="Deposit has not arrived yet"/>
       <option value="Cancel a wire"/>
       <option value="Other issue"/>
       </datalist> 
     </div>
     <div className='token-input'>
     <label className='required mt-3'>Withdrawal/Deposit ID</label><br/>
