  ...
  return (
    ...
    <section id='token-deposite' className='token-deposite'>
     ...
     <label className='required'>Please select your issue below</label><br/>
        ...
        <datalist id="issue">
       <option value="Order may be incorrectly executed"/>
       <option value="Issue with fees"/>
       <option value="Issue with funding payments paid"/>
       <option value="Issue with funding payments received"/>
...
export default TradingAndFunding
