        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/How-is-precision-calculated-using-significant-digits-on-Ekonnet"}><button id='button_active'>How is precision calculated using significant digits on Ekonnet</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    <h2>How is precision calculated using significant digits on Ekonnet</h2>
