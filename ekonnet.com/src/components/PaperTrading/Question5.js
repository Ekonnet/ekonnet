        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Understanding-Ekonnet-Over-the-Counter(OTC)"}><button id='button_active'>Understanding Ekonnet Over the Counter (OTC)</button>    
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    ...
                    <h3>What is Over the Counter (OTC)</h3>
