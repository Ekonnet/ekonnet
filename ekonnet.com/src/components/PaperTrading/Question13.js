        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Price-alert-setting-on-Ekonnet"}><button id='button_active'>Price alert setting on Ekonnet</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    ...
                    <h3>What is a price alert on Ekonnet</h3>
