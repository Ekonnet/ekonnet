        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Trading-Error-Message"}><button id='button_active'>Trading Error Message</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    ...
                    <h3>The Ekonnet platform is either in maintenance or overload</h3>
