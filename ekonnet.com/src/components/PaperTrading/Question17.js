        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Editing-orders-and-viewing-order-history-in-bulk"}><button id='button_active'>Editing orders and viewing order history in bulk</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    ...
                    <h3>How to edit active orders</h3>
