        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Currency-Switch-Tool-on-Ekonnet"}><button id=''>Currency Switch Tool on Ekonnet</button>             
                    </Nav.Link> 
                    ...
                    <Nav.Link as={Link} to={"/How-to-check-you-are-paying-the-right-trading-fees-on-Ekonnet"}><button id='button_active'>How to check you are paying the right trading fees on Ekonnet</button>  
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    ...
                    <h3>What is the difference between taker and maker trading fees on Ekonnet</h3>
