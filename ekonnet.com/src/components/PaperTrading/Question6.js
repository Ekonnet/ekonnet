        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/que1"}><button id=''>Currency Switch Tool on Ekonnet</button>             
                    </Nav.Link> 
                    ...
                    <Nav.Link as={Link} to={"/que6"}><button id='button_active'>How to check you are paying the right trading fees on Ekonnet</button>  
                    </Nav.Link> 
