        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Currency-Switch-Tool-on-Ekonnet"}><button id='button_active'>Currency Switch Tool on Ekonnet</button>             
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    <h2>Currency Switch Tool on Ekonnet</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>How to use the Currency Conversion tool</h3>
