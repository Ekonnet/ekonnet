        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Order-and-Funding-Books-terms-on-Ekonnet"}><button id='button_active'>Order and Funding Books terms on Ekonnet</button>     
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    ...
                    <h3>What are the Order Book terms on Ekonnet</h3>
