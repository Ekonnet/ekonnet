        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/Why-a-stop-order-might-not-be-filled-at-the-stop-price-on-Ekonnet"}><button id='button_active'>Why a stop order might not be filled at the stop price on Ekonnet</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    <h2>Why a stop order might not be filled at the stop price on Ekonnet</h2>
