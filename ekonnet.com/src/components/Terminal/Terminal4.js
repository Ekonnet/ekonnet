        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal4"}><button   id='button_active'>Ethereum 2.0 Staking on Ekonnet</button>
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    <h2>Ethereum 2.0 Staking on Ekonnet</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>How to start staking ETH at Ekonnet</h3>
