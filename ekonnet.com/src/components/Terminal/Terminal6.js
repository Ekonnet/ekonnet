        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal6"}><button id='button_active'>What is Ekonnet Terminal</button>  
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    <h2>What is Ekonnet Terminal</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>What is Dazaar</h3>
