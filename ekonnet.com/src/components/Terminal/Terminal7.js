        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal7"}><button id='button_active'>How to change Sweatcoin to Bitcoin on Ekonnet</button>  
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    <h2>How to change Sweatcoin to Bitcoin on Ekonnet</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>What is Sweatcoin App</h3>
