        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal5"}><button id='button_active'>Staking Rewards on Ekonnet</button>    
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    <h2>Staking Rewards on Ekonnet</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>What is the Ekonnet Staking Program</h3>
