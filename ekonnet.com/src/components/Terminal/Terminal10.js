        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal10"}><button id='button_active'>Ekonnet customer support</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    <h2>Ekonnet customer support</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>How to contact the Ekonnet Support team</h3>
