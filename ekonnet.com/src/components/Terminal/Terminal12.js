        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal12"}><button id='button_active'>How to deactivate a Ekonnet account</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    <h2>How to deactivate a Ekonnet account</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>How to deactivate my Ekonnet account</h3>
