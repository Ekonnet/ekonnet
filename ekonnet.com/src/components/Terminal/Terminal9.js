        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal9"}><button id='button_active'>What is the Ekonnet API</button>
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    <h2>What is the Ekonnet API</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>How to use the Ekonnet API</h3>
