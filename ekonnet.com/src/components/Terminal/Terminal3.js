        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal3"}> <button  id='button_active'>Ontario (Canada) Customers on Ekonnet — Frequently Asked Questions (FAQ)</button>                    
                    </Nav.Link>
                ...
                <div className='col-lg-8 summary'>
                    <h2>Ontario (Canada) Customers on Ekonnet — Frequently Asked Questions (FAQ)</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>Who is an Ontario customer?</h3>
