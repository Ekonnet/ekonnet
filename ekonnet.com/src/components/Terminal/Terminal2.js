        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal2"}><button  id='button_active'>2016 Security Breach Bitcoin Recovery — Frequently Asked Questions (FAQ)</button>
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    <h2>2016 Security Breach Bitcoin Recovery — Frequently Asked Questions (FAQ)</h2>
                    <h5>Last updated 3 November, 2022</h5>
