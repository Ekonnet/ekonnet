        ...
        <div className='container'>
            <div className='row'>
                <div className='col-lg-4'>
                    ...
                    <Nav.Link as={Link} to={"/terminal8"}><button>Ekonnet Delists BCI and BBN</button>     
                    </Nav.Link> 
                    ...
                    <Nav.Link as={Link} to={"/terminal11"}><button id='button_active'>U.S. Person — Frequently Asked Questions (FAQ)</button>
                    </Nav.Link> 
                ...
                <div className='col-lg-8 summary'>
                    <h2>U.S. Person — Frequently Asked Questions (FAQ)</h2>
                    <h5>Last updated 30 November, 2022</h5>
                    <h3>I am a U.S. Person. Can I open an account and trade on Ekonnet?</h3>
