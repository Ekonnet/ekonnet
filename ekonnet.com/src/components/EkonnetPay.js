...
const Ekonnetpay = () => {
  return (
    <>
    <section id='ekonnet_hero' className='ekonnet_hero'>
    ...
    <section id='what_ekonnet' className='what_ekonnet'>
        <div className='container'>
            <div className='row'>
                <div className='col-lg-12 text-center'>
                <h1>What is Ekonnet Pay ?</h1>
                <p>Ekonnet Pay is a widget that allows you to accept crypto payments seamlessly. Access the world of cryptocurrency and explore 
                 its endless possibilities with a simple and easy setup.</p>
                </div>
            </div>
        </div>
    </section>
    <section id='why_ekonnet' className='why_ekonnet'>
        <div className='container'>
            <div className='row'>
                <div className='col-lg-12 text-center'>
    ...
    <section id='ekonnet_crypto' className='ekonnet_crypto'>
        <div className='container'>
            <div className='row'>
                <div className='col-lg-12 text-center'>
    ...
    <section id='options' className='option'>
        <div className='container'>
            <div className='row'>
                <div className='col-lg-12 text-center'>
